...
export default function LoginForm() {
  ...
  return (
    <div className="flex justify-center items-center mt-20 min-h-screen bg-white ring shadow-xl ring-stone-900/5">
      <div className="w-[500px] h-[500px] bg-white rounded shadow-lg outline outline-black/5">
        <div className="flex">
          <button
            className={`w-1/2 py-3 text-center text-orange-100 font-medium ${activeTab === "login"
          ...
          <button
            className={`w-1/2 py-3 text-center text-orange-100 font-medium ${activeTab === "signup"
          ...
          {activeTab === "signup" && (
            <form className="space-y-4">
              ...
              <div className="flex">
                ...
                I accept the <a className="text-stone-600 decoration-2 focus:outline-hidden focus:underline font-medium hover:text-orange-700" href="#">
